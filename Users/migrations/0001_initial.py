# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-05-24 09:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(help_text='添加时间', verbose_name=datetime.datetime.now)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.FloatField(default='', help_text='价格')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('good', models.ManyToManyField(help_text='商品', to='Users.Good')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time', models.DateTimeField(help_text='发生时间', verbose_name=datetime.datetime.now)),
