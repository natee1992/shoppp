...
regitser.regist(UserFavResource('userfavresource'))
regitser.regist(ShoppingHistoryResource('shoppinghistoryresource'))
regitser.regist(CommentResource('commentresource'))
regitser.regist(WatchHistoryResource('watchhistoryresource'))